		...
		<Background>
			<Contents>
				...
				<div style={{ display: "flex", justifyContent: "space-between" }}>
					<div style={{ paddingLeft: "5rem", paddingRight: "4rem", marginTop: "2rem" }}>
						<div style={{ borderTop: "1.3rem solid rgba(69, 146, 179,0.3)", padding: "0 1rem 1rem 1rem", backgroundColor: "#f4f4f4", marginBottom: "3rem" }}>
							<div style={{ fontSize: "1.5rem", fontWeight: "bold", paddingTop: "1rem" }}>
								{name}님의 권장 음주량은 소주 {sojuBottle}병 {sojuGlass}잔 입니다!
							</div>
							<div style={{ marginTop: "1rem" }}>※ 개인 체질을 배제하고 체중만을 고려한 값 입니다.</div>
						</div>
						<div style={{ borderTop: "1.3rem solid rgba(69, 146, 179,0.3)", padding: "0 1rem 1rem 1rem", backgroundColor: "#f4f4f4", marginBottom: "3rem" }}>
							<div style={{ fontSize: "1.5rem", fontWeight: "bold", paddingTop: "1rem" }}>{overdoseStatement}</div>
							<div style={{ marginTop: "1rem" }}>※2019년을 기준으로 한 값 입니다.</div>
						</div>
						<div style={{ borderTop: "1.3rem solid rgba(69, 146, 179,0.3)", padding: "0 1rem 1rem 1rem", backgroundColor: "#f4f4f4", marginBottom: "3rem" }}>
							<div style={{ fontSize: "1.5rem", fontWeight: "bold", paddingTop: "1rem" }}>
					...
					<div style={{ paddingRight: "5rem", marginTop: "2rem" }}>
						<div style={{ borderTop: "1.3rem solid rgba(69, 146, 179,0.3)", padding: "0 1rem 1rem 1rem", backgroundColor: "#f4f4f4", marginBottom: "3rem" }}>
							<div style={{ fontSize: "1.5rem", fontWeight: "bold", paddingTop: "1rem" }}>
								{name}님의 알콜 중독 테스트 점수는 {score}점 입니다.
							</div>
						</div>
						<div style={{ borderTop: "1.3rem solid rgba(69, 146, 179,0.3)", padding: "0 1rem 1rem 1rem", backgroundColor: "#f4f4f4", marginBottom: "3rem" }}>{addictedState()}</div>

...
const ResultPageMobile = (props) => {
  ...
  const addictedState = () => {
    if (score < 9) {
      ...
      return (
        <div>
          <span style={{ color: '#E02828', fontWeight: 'bold' }}>
            당신은 위험음주자 입니다.
          </span>
      ...
      <Contents id="Test-Result">
        ...
        >
          ...
          >
            <div
              style={{
                borderTop: '1vh solid rgba(69, 146, 179,0.3)',
        ...
        <div style={{ position: 'absolute', right: '10vw', bottom: '3vh' }}>
          <ButtonFormMobile onClick={() => onClickRestart()}>
            메인으로 돌아가기
          </ButtonFormMobile>
        </div>
      </Contents>
